...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        OrganBeanDao.createTable(db, ifNotExists);
        RegionBeanDao.createTable(db, ifNotExists);
        LinkBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        OrganBeanDao.dropTable(db, ifExists);
        RegionBeanDao.dropTable(db, ifExists);
        LinkBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(LinkBeanDao.class);
