package com.mtm.flowcheck.widget;
...
public class AVLoadingIndicatorView extends View {
    ...
    private static final BallSpinFadeLoaderIndicator DEFAULT_INDICATOR1=new BallSpinFadeLoaderIndicator();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mIndicator == null){
                setIndicator(DEFAULT_INDICATOR1);
    ...
    public void hide() {
        ...
        if (diff >= MIN_SHOW_TIME || mStartTime == -1) {
            ...
            // so put select_btn_prismatic delayed message in to hide it when its been
            // shown long enough.
            if (!mPostedHide) {
    ...
    void drawTrack(Canvas canvas) {
        ...
        if (d != null) {
            // Translate canvas so select_btn_prismatic indeterminate circular progress bar with padding
    ...
    protected void onDetachedFromWindow() {
        ...
        // queue, which can prevent the entire view hierarchy from being GC'ed during select_btn_prismatic rotation
